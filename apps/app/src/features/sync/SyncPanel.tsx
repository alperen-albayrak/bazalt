  ...
  return (
    <div className="flex flex-col h-full text-sm">
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-4">
        ...
        {error && (
          <p className="text-xs text-red-500 bg-red-50 dark:bg-red-900/20 rounded p-2 break-words">
            {error}
          </p>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            ...
            <input
              className="w-full text-xs border border-gray-300 dark:border-gray-700 rounded px-2 py-1.5 bg-white dark:bg-gray-900 outline-none focus:border-accent"
          ...
          <div>
            ...
            {authToken ? (
              <input
                type="password"
                readOnly
                className="w-full text-xs border border-gray-300 dark:border-gray-700 rounded px-2 py-1.5 bg-gray-50 dark:bg-gray-800 text-gray-400 cursor-not-allowed"
                value={authToken}
              />
            ) : (
              <input
          ...
          <div className="flex gap-2">
            <button
              type="submit"
              className="flex-1 px-2 py-1.5 text-xs bg-accent text-white rounded hover:bg-accent-hover"
            >
              Save
            </button>
            {settings && (
              <button
                ...
                className="px-2 py-1.5 text-xs border border-gray-300 dark:border-gray-700 rounded hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-400"
              >
                Disconnect
              </button>
            )}
